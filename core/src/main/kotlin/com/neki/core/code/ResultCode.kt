...
enum class ResultCode(val code: String, val message: String) {
    ...
    CONFLICT_FOLDER("D-07", message = "해당하는 폴더가 존재합니다."),
    REQUIRED_TERMS_NOT_AGREED("D-08", "필수 약관에 동의해주세요."),
    NO_MORE_RANDOM_POSE("D-09", "더 이상 추천할 포즈가 없습니다."),
    ...
    INVALID_PAGINATION("D-14", "페이지 조회 조건이 올바르지 않습니다."),
