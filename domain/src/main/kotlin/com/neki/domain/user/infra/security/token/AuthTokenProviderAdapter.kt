package com.neki.domain.user.infra.security.token
 ...
 */
@Component
class AuthTokenProviderAdapter(private val appProperties: AppProperties) : AuthTokenProvider {
    ...
    override fun getPrincipalFromRefreshToken(token: String): TokenPrincipal {
