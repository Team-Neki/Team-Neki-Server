package com.neki.domain.map.infra.kakao
 ...
 */
class MapApiClientAdapter(private val apiKey: String, private val restClient: RestClient) : MapApiClient {
    ...
    override fun searchByKeyword(query: String, page: Int, size: Int, rect: String?): SearchedPlaces {
        ...
        return SearchedPlaces(
            places = response.documents.map { kakaoPlace ->
                SearchedPlace(
                    id = kakaoPlace.id,
