...
import com.neki.api.e2e.photo.image.PhotoImageE2ETestBase
...
class DeleteFoldersE2ETest : PhotoImageE2ETestBase() {
    ...
    fun givenMultipleFolders_whenDeleteFolders_thenReturnsSuccess() {
        ...
        RestAssured.given()
            ...
            .body(FolderRequest.DeleteFolders(folderIds = folderIds))
            .`when`()
            .delete("/api/folders")
            .then()
    ...
    fun givenSingleFolder_whenDeleteFolders_thenReturnsSuccess() {
        ...
        RestAssured.given()
            .contentType(ContentType.JSON)
            .header("Authorization", "Bearer $accessToken")
            .body(FolderRequest.DeleteFolders(folderIds = listOf(folder.id!!)))
            .`when`()
            .delete("/api/folders")
            .then()
            .statusCode(HttpStatus.OK.value())
    ...
    fun givenEmptyFolderIds_whenDeleteFolders_thenReturnsBadRequest() {
        ...
        RestAssured.given()
            .contentType(ContentType.JSON)
            .header("Authorization", "Bearer $accessToken")
            .body(FolderRequest.DeleteFolders(folderIds = emptyList()))
            .`when`()
            .delete("/api/folders")
            .then()
    ...
    fun givenNonExistentSingleFolder_whenDeleteFolders_thenReturnsNotFound() {
        ...
        RestAssured.given()
            .contentType(ContentType.JSON)
            .header("Authorization", "Bearer $accessToken")
            .body(FolderRequest.DeleteFolders(folderIds = listOf(nonExistentFolderId)))
            .`when`()
            .delete("/api/folders")
            .then()
            .statusCode(HttpStatus.BAD_REQUEST.value())
    ...
    fun givenOtherUserSingleFolder_whenDeleteFolders_thenReturnsNotFound() {
        ...
        RestAssured.given()
            .contentType(ContentType.JSON)
            .header("Authorization", "Bearer $accessToken")
            .body(FolderRequest.DeleteFolders(folderIds = listOf(otherUserFolder.id!!)))
            .`when`()
            .delete("/api/folders")
            .then()
            .statusCode(HttpStatus.BAD_REQUEST.value())
    ...
    fun givenMultipleFoldersWithPhotos_whenDeleteFoldersWithDeletePhotosTrue_thenAllPhotosDeleted() {
        ...
        RestAssured.given()
            ...
            .header("Authorization", "Bearer $accessToken")
            .queryParam("deletePhotos", true)
            .body(FolderRequest.DeleteFolders(folderIds = listOf(folder1.id!!, folder2.id!!)))
            .`when`()
            .delete("/api/folders")
            .then()
            .statusCode(HttpStatus.OK.value())
    ...
    fun givenPhotoInMultipleFolders_whenDeleteOneFolder_thenPhotoStillInOtherFolder() {
        ...
        RestAssured.given()
            .contentType(ContentType.JSON)
            .header("Authorization", "Bearer $accessToken")
            .body(FolderRequest.DeleteFolders(folderIds = listOf(folderA.id!!)))
            .`when`()
            .delete("/api/folders")
            .then()
            .statusCode(HttpStatus.OK.value())
