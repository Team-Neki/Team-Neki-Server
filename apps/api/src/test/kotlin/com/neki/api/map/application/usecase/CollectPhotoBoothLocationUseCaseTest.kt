...
import com.neki.api.testfixture.aPhotoBoothLocation
...
class CollectPhotoBoothLocationUseCaseTest :
    FunSpec({
        ...
        test("정상 수집 - 신규, 수정, 삭제 location이 올바르게 처리된다") {
            ...
            every { photoBoothLocationRepository.getPhotoBoothLocations(1L) } returns
                listOf(existingLocation1, existingLocation2)
