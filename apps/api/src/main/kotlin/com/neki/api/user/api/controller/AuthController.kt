...
import com.neki.api.user.api.dto.AuthConverter
import com.neki.api.user.api.dto.AuthRequest
import com.neki.api.user.api.dto.AuthResponse
...
class AuthController(
    ...
    @ApiResponses(
        ApiResponse(
            responseCode = "200",
            description = "토큰 갱신 성공 - 새로운 AccessToken과 RefreshToken 발급",
        ),
        ApiResponse(
            responseCode = "400",
