...
/**
 * fileName       : GetFilterUseCase
 * author         : darren
 * date           : 2026. 8. 23.
 * description    : 다각형 영역에서 사용할 수 있는 지도 필터 조회
 *
 * 현재는 브랜드 필터만 제공한다. 필터가 늘어나면 MapResult.PolygonFilter 에 필드를 추가한다.
 *
...
class GetFilterUseCase(
    ...
    fun execute(query: MapQuery.PolygonFilter): MapResult.PolygonFilter {
        ...
        return BrandAssembler.toPolygonFilter(sortedBrands, boothCounts)
    }
}
