 ...
 */
class GetBrandUseCaseTest : FunSpec({
    ...
    test("정상 조회 - 브랜드 목록과 미디어 storageKey가 올바르게 매핑된다") {
        ...
        val storageInfo1 = MediaStorageInfo(mediaId = 10L, storageKey = "brand/lifefour.jpg", contentType = "image/jpeg")
        val storageInfo2 = MediaStorageInfo(mediaId = 20L, storageKey = "brand/harufilm.jpg", contentType = "image/jpeg")
