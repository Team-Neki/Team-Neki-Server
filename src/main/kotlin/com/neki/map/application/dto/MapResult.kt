...
object MapResult {
    ...
    data class GetPolygonLocation(val locations: List<PhotoBoothLocationDto>, val favoriteLocationIds: Set<Long>)
    ...
    data class GetFavoriteMap(val locations: List<PhotoBoothLocationDto>)
}
