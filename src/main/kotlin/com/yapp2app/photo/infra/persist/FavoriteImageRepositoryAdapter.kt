 ...
 */
@Repository
class FavoriteImageRepositoryAdapter(private val jpaRepository: JpaFavoriteImageRepository) :
    ...
    override fun remove(userId: Long, photoId: Long) = jpaRepository.deleteById(
